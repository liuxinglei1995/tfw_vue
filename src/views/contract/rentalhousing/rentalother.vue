    ...
    <el-form ref="elForm" :inline="true" :model="formData" label-width="100px" size="medium">
      <el-col>
        <el-form-item label="解决纠纷方式" prop="field101">
          <el-select v-model="formData.field101" :style="{ width: '100%' }" clearable
                     placeholder="请选择解决纠纷方式解决纠纷方式"
          >
            <el-option v-for="(item, index) in field101Options" :key="index" :disabled="item.disabled" :label="item.label"
                       :value="item.value"
            ></el-option>
          </el-select>
        </el-form-item>
      ...
      <el-col>
        <el-form-item label="备注" prop="field102">
          <el-input  style="width: 800px" v-model="formData.field102" :autosize="{ minRows: 4, maxRows: 4 }"
                    placeholder="请输入本文行多备注备注" type="textarea"
          ></el-input>
        </el-form-item>
      </el-col>
      <el-col>
        <el-form-item>
          家具清单：空调挂机2台，柜机1台，冰箱1台，洗衣机1台，次卧高低床1张，主卧床1张，沙发1套，电视柜1个，餐桌1张，餐椅4把，茶几1张；电视机1台；
          1、承租方租期内：小件物品自行修复自行付费，大件物品如果自然损坏可以通知出租方检修或者更换；
          2、此租金仅为房屋租金，不含物业费；
          3、物业费、水电气等费用由承租方支付；
          4、承租方合同到期前，需要提起一个月告知出租方是续租，到期后退租；
        </el-form-item>
      </el-col>
<el-col>
  <el-form-item label="签约地点" prop="field103">
    <el-input v-model="formData.field103" :style="{ width: '100%' }" clearable placeholder="请输入签约地点">
    </el-input>
  </el-form-item>
  <el-form-item label="签约日期" prop="field104">
    <el-date-picker v-model="formData.field104" :style="{ width: '100%' }" clearable
                    format="yyyy-MM-dd" placeholder="请选择签约日期" value-format="yyyy-MM-dd"
    ></el-date-picker>
  </el-form-item>
</el-col>
  <el-col>
    <el-form-item label="水底数" prop="field111">
      <el-input v-model="formData.field111" :style="{ width: '100%' }" clearable placeholder="请输入水底数">
      </el-input>
    </el-form-item>
    <el-form-item label="电底数" prop="field112">
      <el-input v-model="formData.field112" :style="{ width: '100%' }" clearable placeholder="请输入电底数">
      </el-input>
    </el-form-item>
    <el-form-item label="气底数" prop="field113">
      <el-input v-model="formData.field113" :style="{ width: '100%' }" clearable placeholder="请输入气底数">
      </el-input>
    </el-form-item>
  </el-col>
      ...
      <el-col style="display: flex">
        <el-form-item label="业主身份证国徽面照片" prop="image7">
      ...
      <el-col style="display: flex">
        <el-form-item label="租户身份证国徽面照片" prop="image12">
