    ...
    <div class="app-container">
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple"
                    @click="handleDelete" v-hasPermi="['system:follow:remove']">删除</el-button>
            </el-col>
            <el-col :span="1.5">
        ...
        <el-table v-loading="loading" :data="fangyuanList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="小区名字" align="center">
                ...
                <template slot-scope="scope">
                    {{ scope.row.loupanXq ? scope.row.loupanXq.title : "" }}
                </template>
            </el-table-column>
            ...
            <el-table-column label="提交时间" align="center" prop="updatedAt" />
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right">
                ...
                <template slot-scope="scope">
                    <el-button size="mini" type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)"
                        v-hasPermi="['system:follow:edit']">审核</el-button>
        ...
        <el-dialog :title="title" :visible.sync="open2" width="1000px" append-to-body :close-on-click-modal="false"
            ...
            <el-form ref="form" :model="form" label-width="90px" :inline="true" disabled="false">
            ...
            { required: false }]">
                                        ...
                                        <el-form-item label="售价" prop="sellingPrice" size="mini"
                                            v-if="dict.value === '1'" :rules="'1' === form.type ? [
            ...
            { required: false }]">
                                        ...
                                        <!-- 出租 -->
                                        <el-form-item label="租金" prop="rental" size="mini" v-if="dict.value === '2'"
                                            :rules="'2' === form.type ? [
            { required: true, message: '租金不能为空', trigger: 'blur' }] : [
            { required: false }]">
                                            <el-input v-model="form.rental" placeholder="请输入租金" style="width:120px" />
                                        </el-form-item>
                                        <el-form-item label="出租方式" prop="rentalMethod" size="mini"
            ...
            { required: false }]">
                                        ...
                                        <el-form-item label="免租时间" prop="rentFreeTime" size="mini"
                                            v-if="dict.value === '2'" :rules="'2' === form.type ? [
            ...
            { required: false }]">
                                        ...
                                        <el-form-item label="租金" prop="rental" size="mini" v-if="dict.value === '3'"
                                            :rules="'3' === form.type ? [
            { required: true, message: '租金不能为空', trigger: 'blur' }] : [
            { required: false }]">
                ...
                <el-input v-model="form.transactionOwnership" placeholder="请输入交易权属" />
                        ...
                        <el-card class="box-card">
                            ...
                            <el-form-item label="产权日期" prop="titleDeedDate" size="mini">
                                <el-date-picker clearable v-model="form.titleDeedDate" type="date"
                                    value-format="yyyy-MM-dd" placeholder="请选择产权日期">
                                </el-date-picker>
                            </el-form-item>
                            ...
                            <el-form-item label="国土证日期" prop="housingPeriod" size="mini">
                                <el-date-picker clearable v-model="form.housingPeriod" type="date"
                                    value-format="yyyy-MM-dd" placeholder="请选择国土证日期">
                                </el-date-picker>
                            </el-form-item>
                        </el-card>
                            ...
                            <el-col :span="24">
                                ...
                                <el-form-item label="房源状态" prop="state" size="mini">
                                    <el-select v-model="form.state" placeholder="请选择房源状态">
                                        <el-option v-for="  dict   in   dict.type.twf_state  " :key="dict.value"
                                            :label="dict.label" :value="dict.value">
                                        </el-option>
                                    </el-select>
                                </el-form-item>
                        ...
                        <el-card class="box-card">
                            ...
                            <el-form-item label="置顶到期时间" prop="topExpiryTime" size="mini">
                                <el-date-picker clearable v-model="form.topExpiryTime" type="date"
                                    value-format="yyyy-MM-dd" placeholder="请选择置顶到期时间">
                                </el-date-picker>
                            </el-form-item>
                        ...
                        <el-card class="box-card">
                            ...
                            <el-col :span="24">
                                <el-form-item label="房源详情" prop="detailed" size="mini">
                                    <el-input v-model="form.detailed" type="textarea" placeholder="请输入内容"
                                        maxlength="300" show-word-limit :autosize="{ minRows: 4, maxRows: 6 }"
                                        style="width: 600px" />
                                </el-form-item>
                            </el-col>
                            <el-col :span="24">
                                <el-form-item label="房源特色" prop="features" size="mini">
                                    <el-input v-model="form.features" placeholder="请输入房源特色" maxlength="60"
                                        show-word-limit :autosize="{ minRows: 2, maxRows: 4 }" type="textarea"
                                        style="width: 600px" />
                                </el-form-item>
                            </el-col>
                        </el-card>
            ...
            <div class="footerbox">
                <el-button type="primary" @click="backnextfn">上一页</el-button>
                <el-button type="primary" @click="nextfn">下一页</el-button>
                <el-button type="primary" @click="submitaudit">通过审核</el-button>
                <el-button type="primary" @click="savedraftsbox">审核未通过</el-button>
                <el-button @click="cancel">取 消</el-button>
            </div>
        </el-dialog>
    </div>
...
export default {
    ...
    methods: {
        ...
        getList() {
            ...
            getauditList(this.queryParams).then(response => {
