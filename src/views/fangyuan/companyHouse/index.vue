        ...
        <template slot-scope="scope">
          <div style="display: flex; align-items: center">
            ...
            >
              ...
              <div>
                <sapn style="color: #b4bccc"
                  >所属公司:{{ scope.row.companyDept.deptName }}</sapn
                >
              </div>
            </div>
          </div>
          ...
          <el-tab-pane label="基本信息" name="first">
            <div class="messagebox">
              ...
              <div class="rightmessagebox">
                ...
                <p class="adress" style="display: flex; align-items: center;">
            ...
            <el-row :gutter="20" class="listtitle">
              ...
              <el-col :span="6">
                <el-card shadow="hover">
                  ...
                  <div v-if="showshishi">{{ form.propertyArea }}㎡</div>
                </el-card>
              </el-col>
...
import lookprice from "../fangyuan/lookprice.vue";
import looklog from "@/views/source/looklog";
import ImagePreviewHouse from "../ImagePreviewHouse";
import listImageUpload from "./imageUpload.vue";
  ...
  methods: {
    ...
    handlegenjin(row) {
      ...
      getFangyuan(this.genjinid).then((response) => {
        ...
        console.log(this.form.kfang, "kfang");
    ...
    /** 搜索按钮操作 */
    handleQuery() {
      // console.log(this.dict.type.tfw_prices)
