<template>
  <div class="component-upload-image">
    ...
    <el-dialog :visible.sync="dialogVisible" title="预览" width="1200px" append-to-body>
      <img :src="dialogImageUrl" style="display: block; max-width: 100%;height: 100%; margin: 0 auto" />
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      uploadImgUrl: process.env.VUE_APP_BASE_API + "/common/uploadQiNiuStencil", // 上传的图片服务器地址
      headers: {
  ...
  methods: {
    ...
    handleUploadSuccess(res, file) {
      if (res.code === 200) {
        this.baseUrl = res.qn
        this.uploadList.push({ qn: res.qn, name: res.fileName, url: res.url });
